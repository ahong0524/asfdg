...
// if (VX.store.list.length === 0) {
//   VX.store.list[0] = router.getRoutes()[1]
// } else {
//   for (let i = 0; i <= VX.store.list.length; i++) {
//     // let number = null
//     if (router.getRoutes()[1] === VX.store.list[i]) {
//     }
//   }
// }
// }
